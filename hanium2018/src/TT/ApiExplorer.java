...
public class ApiExplorer {
    public static void main(String[] args) throws IOException {
        ...
        urlBuilder.append("?" + URLEncoder.encode("ServiceKey","UTF-8") + "=z3vRY90dre5b7j2pwhZZeX06JeC12PNASKeSADwJdAgOim8mgUzq1fd1wIdomXONKstjwoq2BwYfH4Khhras0A%3D%3D"); /*Service Key*/
